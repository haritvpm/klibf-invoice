...
class MlaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.mlas.index', compact('mlas'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.mlas.create');
    }
    ...
    public function store(StoreMlaRequest $request)
    {
        ...
        return redirect()->route('frontend.mlas.index');
    }
    ...
    public function edit(Mla $mla)
    {
        ...
        return view('frontend.mlas.edit', compact('mla'));
    }
    ...
    public function show(Mla $mla)
    {
        ...
        return view('frontend.mlas.show', compact('mla'));
    }
