...
class SanctionedAmountController extends Controller
{
   ...
   //     $members = Member::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
        ...
        return view('frontend.sanctionedAmounts.create', compact('book_fests', 'fin_years', 'members'));
    }
    ...
    public function edit(SanctionedAmount $sanctionedAmount)
    {
        ...
        return view('frontend.sanctionedAmounts.edit', compact('book_fests', 'fin_years', 'members', 'sanctionedAmount'));
    }
    ...
    public function show(SanctionedAmount $sanctionedAmount)
    {
        ...
        return view('frontend.sanctionedAmounts.show', compact('sanctionedAmount'));
    }
