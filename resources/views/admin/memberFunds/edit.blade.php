    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.member-funds.update", [$memberFund->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('as_amount_prev') ? 'is-invalid' : '' }}" type="number" name="as_amount_prev" id="as_amount_prev" value="{{ old('as_amount_prev', $memberFund->as_amount_prev) }}" step="0.01">
