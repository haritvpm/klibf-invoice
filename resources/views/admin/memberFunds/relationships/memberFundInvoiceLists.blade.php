...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-memberFundInvoiceLists">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.invoiceList.fields.member_fund') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($invoiceLists as $key => $invoiceList)
                        <tr data-entry-id="{{ $invoiceList->id }}">
                            ...
                            <td>
                                {{ $invoiceList->member_fund->as_amount ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-memberFundInvoiceLists:not(.ajaxTable)').DataTable({ buttons: dtButtons })
