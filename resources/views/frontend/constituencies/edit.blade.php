    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.constituencies.update", [$constituency->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.constituency.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $constituency->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name_mal" id="name_mal" value="{{ old('name_mal', $constituency->name_mal) }}">
